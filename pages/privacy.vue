  ...
  <div class="page-privacy">
    <div class="page-main">
      <div class="global_container privacy_main">
        ...
        <p>Score平台注重保护用户个人信息及个人隐私。本隐私权保护声明解释了用户个人信息收集和使用的有关情况，本隐私权保护声明适用于Score平台的所有相关服务。您可以选择不使用Score平台服务，但如果您使用Score平台服务的，您的使用行为将被视为对本声明全部内容的认可。“Score平台”指由上海厚翰信息科技有限公司（简称“Score”）运营的网络交易平台，域名为 www.famulei.com以及Score启用的其他域名。
          知识产权声明</p>
        ...
        <p style="text-align: right;margin-top: 2em">上海厚翰信息科技有限公司</p>
