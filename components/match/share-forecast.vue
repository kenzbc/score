<template>
  <div class="share-modal forecast" v-if="show">
      ...
      <div class="capture-box" id="capture">
        <div class="dialog-box">
          ...
          <div class="share-head">
            <img :src="matchInfo.team_a_image_thumb || $score.defaultScoreImg" width="44">
            <span class="team-name">{{matchInfo.team_a_short_name}}</span>
            <div class="vs">VS</div>
            <span class="team-name">{{matchInfo.team_b_short_name}}</span>
            <img :src="matchInfo.team_b_image_thumb || $score.defaultScoreImg" width="44">
          </div>
          ...
          <div class="text-content">
            ...
            <div class="post-tips">{{matchInfo.forecast.add_time | tsToaGo}} 发布了一条预测</div>
            <div class="quote-content">
              <img src="/static/images/match/icon_quote-left@2x.png" width="20">
              <div>
                <p class="title">{{matchInfo.forecast.forecast_teamID | getTeamId2Name(matchInfo)}}胜利</p>
                <p class="text">
                  {{matchInfo.forecast.content ? matchInfo.forecast.content : '还没有发表看法' | stringEllipsis(74)}}
                </p>
              </div>
            ...
            <div class="footer-score">
              <div class="title">共 {{matchInfo.total_forecast_count}} 位玩家参与预测</div>
              <div class="subtitle">预测正确可得 3 果子</div>

              <div class="score">
                <div class="s-name">
                  <span class="blue">{{matchInfo.team_a_short_name}}  {{matchInfo.forecast_a_p}}</span>
                  <span class="red">{{matchInfo.team_b_short_name}}  {{matchInfo.forecast_b_p}}</span>
                </div>
                <div class="s-score">
    ...
    methods: {
      createImg(){
        ...
        html2canvas(document.querySelector("#capture"),{
          ...
          _this.saveFile(strDataURI,'myForecast');
      ...
      .dialog-box {
        ...
        .text-content{
          ...
          .quote-content{
            ...
            padding-bottom:18px;
            border-bottom:1px dashed #D2D4D9;
          ...
          .footer-score{
            ...
            .score{
              ...
              .s-score{
                ...
                .l-bar {
                  height: 100%;
                  background: linear-gradient(135deg, #0d7eff 0%, #0f97ff 100%);
                ...
                .r-bar {
                  height: 100%;
                  background: linear-gradient(225deg, #ff4c6a 0%, #ff6b89 100%);
